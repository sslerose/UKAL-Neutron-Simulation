...
PrimaryGeneratorMessenger::PrimaryGeneratorMessenger()
{
  ...
  fExposureTimeCmd->SetRange("exposureTime >= 0");
  fExposureTimeCmd->SetUnitCategory("Time");
  fExposureTimeCmd->SetDefaultUnit("s");
  fExposureTimeCmd->SetDefaultValue(0.0);
  fExposureTimeCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
...
void PrimaryGeneratorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  // Set exposure time
  //========================================================================//
  else if (command == fExposureTimeCmd) {
    config->SetExposureTime(fExposureTimeCmd->GetNewDoubleValue(newValue));
  }

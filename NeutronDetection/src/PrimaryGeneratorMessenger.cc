  ...
  : fPrimaryGenerator(generator)
{
  ...
  // Uses same /neutrondet/ base as DetectorMessenger for consistency
  //========================================================================//
  fGunDir = new G4UIdirectory("/neutrondet/gun/");
  ...
  //========================================================================//
  fUseSimLiTCmd = new G4UIcmdWithABool("/neutrondet/gun/useSimLiT", this);
  ...
  //========================================================================//
  fBeamEnergyCmd = new G4UIcmdWithADouble("/neutrondet/gun/beamEnergy", this);
  ...
  //========================================================================//
  fBeamSigmaCmd = new G4UIcmdWithADouble("/neutrondet/gun/beamSigma", this);
  ...
  //========================================================================//
  fTargetMaterialCmd = new G4UIcmdWithAString("/neutrondet/gun/targetMaterial", this);
  ...
  fTargetMaterialCmd->SetGuidance("    LiF  - Lithium fluoride (default)");
  ...
  //========================================================================//
  fTargetThicknessCmd = new G4UIcmdWithADouble("/neutrondet/gun/targetThickness", this);
  ...
  //========================================================================//
  fPrintCmd = new G4UIcmdWithoutParameter("/neutrondet/gun/printParameters", this);
  ...
  //========================================================================//
  fGunEnergyCmd = new G4UIcmdWithADoubleAndUnit("/neutrondet/gun/energy", this);
...
{
  G4cout << "*** SetNewValue called with: " << command->GetCommandPath() 
         << " = " << newValue << " ***" << G4endl;
  G4cout.flush();
  ...
  if (command == fUseSimLiTCmd) {
    fPrimaryGenerator->SetUseSimLiT(fUseSimLiTCmd->GetNewBoolValue(newValue));
    if (fUseSimLiTCmd->GetNewBoolValue(newValue)) {
      G4cout << "Neutron source: SimLiT 7Li(p,n)7Be enabled" << G4endl;
    } else {
      G4cout << "Neutron source: Simple particle gun enabled" << G4endl;
    }
  }
  ...
  //========================================================================//
    ...
    G4double energy = fBeamEnergyCmd->GetNewDoubleValue(newValue);
  ...
  //========================================================================//
    ...
    G4double sigma = fBeamSigmaCmd->GetNewDoubleValue(newValue);
  ...
  //========================================================================//
    ...
    fPrimaryGenerator->SetTargetMaterial(newValue);
  }
  ...
  //========================================================================//
    ...
    fPrimaryGenerator->SetTargetThickness(thickness);
  }
  ...
  //========================================================================//
    ...
    fPrimaryGenerator->PrintParameters();
  }
  ...
  //========================================================================//
    ...
    fPrimaryGenerator->GetParticleGun()->SetParticleEnergy(
      fGunEnergyCmd->GetNewDoubleValue(newValue));
    G4cout << "Particle gun energy set to " 
           << G4BestUnit(fGunEnergyCmd->GetNewDoubleValue(newValue), "Energy") 
           << G4endl;
  }
}
